...
<body>
   ...
   <div id="sidemenu">
      ...
      <div class="row">
        <div id="displayprofilephoto" class="col-lg-4" style=" text-align: center;"></div>
        <div id="displayprsonalinfo" class="col-lg-8"></div>
      </div>
...
<script>
    ...
    function profile(getid, getvalue){
       document.getElementById("sidemenu").style.width="800px";
      //  document.getElementById("main").style.marginRight="500px";
        ...
        request.open('GET',callvalue+'.json');
